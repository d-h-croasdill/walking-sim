...
/// <summary>
/// snagged this code from sharpcoderblog (https://sharpcoderblog.com/blog/unity-3d-openable-door-tutorial), tweaked it a little bit.
/// </summary>
/// 
public class DoorOpener : MonoBehaviour
{
    ...
    void OnGUI()
    {
        if (enter)
        {
            GUI.Label(new Rect(Screen.width / 2 - 75, Screen.height - 100, 150, 30), "E");
        }
    }
